...
namespace DigitalPaymentManagement.Controllers
{
    public class BranchController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BranchId,BranchName,BranchCode,CenterId")] Branch branch)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BranchName,BranchCode,CenterId")] Branch branch)
        {
            if (id != branch.Id)
            {
                return NotFound();
